package com.example.stage24.security.services;


import com.example.stage24.user.domain.RefreshToken;
import com.example.stage24.user.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    @Value("${application.security.jwtRefreshExpirationMs}")
